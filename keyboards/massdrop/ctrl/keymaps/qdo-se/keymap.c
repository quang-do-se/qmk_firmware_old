...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
               ...
               KC_CAPS, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, KC_RGUI, MO(1),   KC_ENT,            KC_LEFT, KC_DOWN, KC_RGHT \
               ),
  [1] = LAYOUT(
               _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            KC_MUTE, _______, _______, \
               KC_GRV,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_MPLY, KC_MSTP, KC_VOLU, \
               L_T_BR,  L_PSD,   L_BRI,   L_PSI,   _______, _______, _______, U_T_AGCR,KC_UP  , _______, KC_PGUP, KC_HOME, _______, _______,   KC_MPRV, KC_MNXT, KC_VOLD, \
               L_T_PTD, L_PTP,   L_BRD,   L_PTN,   _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT,KC_PGDN, KC_END,  _______, \
               _______, L_T_MD,  L_T_ONF, _______, _______, MD_BOOT, NK_TOGG, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,                              _______, \
...
led_instruction_t led_instructions[] = {
  ...
  // { .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id0 = 0xFFFFFFFF, .id1 = 0xFFFFFFFF, .id2 = 0x007FFFFF, .r = 255, .g=255, .b=255 },
  // { .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB , .id2 = 0xFF800000, .id3 = 0x00FFFFFF, .r=255, .g=255, .b=255 },
