...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNCTION] = LAYOUT_60_ansi(
                           ...
                           _______,  _______,  _______,                      _______,                                MO(3),    MO(2),    MO(1),              _______
                           ),
  [_RGB] = LAYOUT_60_ansi(
  ...
  [_ALT] = LAYOUT_60_ansi(
                          TO(0),   TO(1),    TO(2),    TO(3),    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
