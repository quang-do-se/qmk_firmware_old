...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |     |     |     |     |     |     |     |     |     |     |     |     |     |   Reset   |
   * |-----------------------------------------------------------------------------------------+
   * | BL Tog |BLInc|BLDec|BLStp|BLBrt|     |     |     |     |     |     |     |     |        |
   * |-----------------------------------------------------------------------------------------+
  ...
  [_FUNCTION] = LAYOUT_60_ansi(
                       ...
                       _______,  _______,  _______,                      _______,                                MO(3)  ,  MO(2),    _______,            _______
                       ),
  [_RGB] = LAYOUT_60_ansi(
                       _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  RESET,
                       BL_TOGG, BL_INC,   BL_DEC,   BL_STEP,  BL_BRTG,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
  ...
  [_ALT] = LAYOUT_60_ansi(
                       TG(0),   TG(1),    TG(2),    TG(3),    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
