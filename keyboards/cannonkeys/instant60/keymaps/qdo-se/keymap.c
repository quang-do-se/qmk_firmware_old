...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNCTION] = LAYOUT_60_ansi(
                                 ...
                                 _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_UP,                        MO(_SWITCH),
    ...
    [_RGB] = LAYOUT_60_ansi(
                            ...
                            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,                      MO(_SWITCH),
    ...
    [_SWITCH] = LAYOUT_60_ansi(
                               ...
                               _______,  _______,     _______,  _______,          _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,                      MO(_SWITCH),
                               _______,  _______,     _______,                              _______,                                _______,  _______,  _______,            _______ 
                               ),
};
